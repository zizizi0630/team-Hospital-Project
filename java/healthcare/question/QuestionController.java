...
import healthcare.answer.AnswerForm;
...
public class QuestionController {
    ...
    public String list(Model model, @RequestParam(value = "page", defaultValue = "0") int page,
        ...
        Page<Question> paging = this.questionService.getList(page, kw, siteUser);
    ...
    @GetMapping(value = "/detail/{id}") // http://localhost:8080/question/detail/2
    public String detail(Model model, @PathVariable("id") Long id, AnswerForm answerForm, Principal principal) {
        ...
        } else if (!question.getAuthor().getUserid().equals(principal.getName())) {
    ...
    @GetMapping("/api/answer/count/{id}")
    @org.springframework.web.bind.annotation.ResponseBody
    public Integer getAnswerCount(@PathVariable("id") Long id) {
        Question question = this.questionService.getQuestion(id);
